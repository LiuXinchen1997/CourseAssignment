					...
					<DIV class=right_wai>
						<DIV class=shuming>
							<DIV class=shuming_left>
								...
								<SPAN class=black000><A name=top_bk></A>${book.name
									}</SPAN>
							</DIV>
							<DIV class=book_case>
								<SPAN class=seriesname>丛书名： ${book.name }</SPAN>
							</DIV>
						...
						<DIV class=book_left>
							<DIV class=book_pic>
								<IMG id=img_show_prd
										src="/BookStoreOL/bookImages/${book.image}">
								</A>
							</DIV>
						...
						<DIV class=book_right>
							...
							<DIV class=jiage>
								<SPAN class=gray87>定价：<SPAN>￥${book.price
										}</SPAN></SPAN>
							...
							<a href="<%=request.getContextPath() %>/BuyBook?id=${book.id}" onClick="return confirm('您确定要购买吗？')"> 
