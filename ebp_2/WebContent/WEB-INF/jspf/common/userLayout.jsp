                ...
                <div id="navigation">
                    <div id="inner">
                        ...
                        <ul>
                            ...
                            <li><a href="/ebp_2/user/queryAllOrderList" class="personal">在线订票</a><li>
                            <li><a href="user/queryAllOrders" class="exam">我的订单</a><li>
                            <li><a href="user/updateUser.jsp" class="examlog">个人信息</a><li>
                            <li><a href="user/TopUpAccount.jsp" class="examlog">账户冲值</a><li>
                            <li><a href="user/logout" class="logout" onClick="return confirm('您确定要退出吗？')">注&nbsp;&nbsp;&nbsp;销</a><li>
                        </ul>
                    </div>
                </div>
                <div id="content">
