...
<c:url var="queryByDateUrl" value="/admin/queryUsersByDatePage" scope="request" />
<c:url var="queryByConditionUrl" value="/admin/queryUsersByCondition" scope="request" />
...
<table border="1" cellspacing="0"
		...
		<tr>
			<td colspan="12"
				...
				起始日期：<input type="text" id="starttime"  name="begin" value="${begin}"/> 
				终止日期：<input type="text" id="endtime"  name="end" value="${end }"/>
	...
	<table border="0" cellspacing="0"
		style=" width: 100%; border-left: 0; border-top: 0; border-right: 0;">
		<tr align="center"><td><font color = "red" size = "-1">${error}</font></td></tr>
		<tr align="center">
			<td>	
			<c:if test="${isDate ==1 }">
